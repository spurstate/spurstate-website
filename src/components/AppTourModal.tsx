...
const tourSteps = [
  ...
  },
  {
    ...
    description: 'Fill in a short form — topic, year level, learning area, duration. Workdesk handles the rest, building a complete New Zealand Curriculum-aligned plan.',
