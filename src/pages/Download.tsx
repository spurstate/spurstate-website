...
import { Monitor, Apple, ArrowRight, Shield, CheckCircle, Download as DownloadIcon } from 'lucide-react'
...
const steps = [
  { step: '1', title: 'Download for your system', description: 'Choose Mac or Windows below. The installer is small and runs directly on your computer.' },
  { step: '2', title: 'Run the setup wizard', description: 'A short 4-step setup captures your school, class, and term priorities. Takes about 10 minutes.' },
  { step: '3', title: 'Generate your first document', description: 'Fill a form, click generate. Your first lesson plan or report comment is ready in seconds.' },
]
    ...
    <div className="pt-16">
          ...
          <div className="mt-8 rounded-2xl bg-blue-50 border border-blue-100 p-6 flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Workdesk is currently in beta and we're looking for 5 Auckland primary school teachers to try it. Access is free and Spurstate covers all AI processing costs during the trial period.{' '}
      ...
      <section className="bg-white py-24 border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-6">
          <p className="text-3xl font-bold text-gray-900 mb-3 whitespace-nowrap">Have questions before downloading?</p>
          <p className="text-base text-gray-500 mb-8">See the full feature list or get in touch — we're happy to answer anything.</p>
          <div className="flex gap-4">
            <Link
              to="/workdesk"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl border border-gray-200 text-gray-700 font-semibold hover:bg-gray-50 transition-colors text-sm"
            >
              See all features
            </Link>
            <Link
